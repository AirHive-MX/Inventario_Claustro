        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-12">
            <img
              src="/logo.png"
              alt="Air Hive Logo"
              className={`h-12 w-auto ${theme === 'dark' ? 'brightness-0 invert' : ''}`}
            />
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-ah-navy dark:text-white tracking-tight">
          ...
          <div className="flex items-center gap-3 sm:gap-5">
            ...
            <button
              onClick={toggleTheme}
              className="theme-toggle w-12 h-12 rounded-full flex items-center justify-center bg-gray-100 dark:bg-white/15 hover:bg-gray-200 dark:hover:bg-white/25 border border-transparent dark:border-white/20 cursor-pointer transition-colors"
            ...
            >
              <img
                ...
                className={`w-7 h-7 object-contain ${theme === 'dark' ? 'brightness-0 invert' : ''}`}
              />
            </button>
            ...
            <div className="flex items-center gap-3">
              ...
              <img
                ...
                className="w-12 h-12 rounded-full object-cover object-top border-2 border-ah-gray/50 dark:border-white/40 shadow-sm"
